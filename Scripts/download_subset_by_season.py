...
if use_azcopy_for_download:
    ...
    for ds_name in downloads_by_dataset:
        ...
        # this azcopy feature is unofficially documented at https://github.com/Azure/azure-storage-azcopy/
        # wiki/Listing-specific-files-to-transfer
